...
module.exports.run = async (client, message, args) => {
    ...
    const embed = new Discord.MessageEmbed()
        ...
        .setAuthor(b.username + "#" + b.discrim, b.avatar , "https://anka.qtr1.repl.co/bot/" + b.botID)
        .setDescription("**[Vote for the bot named " + b.username + "#" + b.discrim + " in Anka.](https://anka.qtr1.repl.co/bot/" + b.botID + "/vote)**")
